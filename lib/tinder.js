...
class TinderClient {
    ...
    assignDecodedValues(response) {
        this.refreshToken =
            this.constructor.getField(response, "refreshToken") ||
                this.refreshToken;
        this.userId =
            this.constructor.getField(response, "userId") || this.userId;
        this.onboardingToken =
            this.constructor.getField(response, "onboardingToken") ||
                this.onboardingToken;
        this.token =
            this.constructor.getField(response, "onboardingToken") ||
                this.token;
        this.xAuthToken =
            this.constructor.getField(response, "authToken") ||
                this.xAuthToken;
    ...
    async onboardingComplete(o) {
        ...
        const response = await this._call("https://api.gotinder.com/v2/onboarding/complete", {
            method: "POST",
            body: JSON.stringify(o),
            headers: {
                token: this.onboardingToken,
    ...
    async passRecId(o) {
        ...
        const response = await (0, node_fetch_1.default)("https://api.gotinder.com/pass/" + o.id, {
            method: "POST",
            headers: {
                "user-agent": this.userAgent,
                "os-version": this.osVersion,
