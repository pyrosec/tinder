...
const fingerprints_1 = __importDefault(require("@upwife/fingerprints"));
...
const randomDevice = () => {
    return fingerprints_1.default[Math.floor(Math.random() * fingerprints_1.default.length)];
};
...
class TinderClient {
    ...
    async checkIp() {
        ...
        const response = await (0, node_fetch_1.default)("https://api64.ipify.org", {
            agent: this.proxyOptions && new socks_proxy_agent_1.SocksProxyAgent(this.proxyOptions),
            method: "GET",
        });
